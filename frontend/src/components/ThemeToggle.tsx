...
export default function ThemeToggle() {
  ...
  return (
    <button
      onClick={cycle}
      className="w-8 h-8 rounded-full flex items-center justify-center hover:bg-black/5 dark:hover:bg-white/5 transition"
    ...
    >
      ...
      {theme === "system" && (
        <svg className="w-4.5 h-4.5 text-[var(--muted)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
