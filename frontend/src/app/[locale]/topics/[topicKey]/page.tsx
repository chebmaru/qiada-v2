      ...
      {(isAr ? topic.contentAr : topic.contentIt) && (
        <div className="bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded-xl p-4 mb-6">
          <div className="flex items-center justify-between mb-2">
            ...
            <TTSButton text={(isAr ? topic.contentAr : topic.contentIt)!} lang={isAr ? "ar" : "it"} />
          </div>
          ...
          <div className="space-y-3">
            {(isAr ? tricks.truePatternsAR : tricks.truePatternsIT) && (
              <div className="bg-green-100/50 dark:bg-green-900/30 rounded-lg p-3">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-xs font-semibold text-green-700 dark:text-green-400">{isAr ? "صحيح" : "VERO"}</p>
                  <TTSButton text={(isAr ? tricks.truePatternsAR : tricks.truePatternsIT)!} lang={isAr ? "ar" : "it"} />
                </div>
            ...
            {(isAr ? tricks.falsePatternsAR : tricks.falsePatternsIT) && (
              <div className="bg-red-100/50 dark:bg-red-900/30 rounded-lg p-3">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-xs font-semibold text-red-700 dark:text-red-400">{isAr ? "خطأ" : "FALSO"}</p>
                  <TTSButton text={(isAr ? tricks.falsePatternsAR : tricks.falsePatternsIT)!} lang={isAr ? "ar" : "it"} />
                </div>
            ...
            {(isAr ? tricks.memoryRuleAR : tricks.memoryRuleIT) && (
              <div className="bg-blue-100/50 dark:bg-blue-900/30 rounded-lg p-3">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-xs font-semibold text-blue-700 dark:text-blue-400">{isAr ? "قاعدة للتذكر" : "Regola da ricordare"}</p>
                  <TTSButton text={(isAr ? tricks.memoryRuleAR : tricks.memoryRuleIT)!} lang={isAr ? "ar" : "it"} />
                </div>
            ...
            {(isAr ? tricks.commonMistakeAR : tricks.commonMistakeIT) && (
              <div className="bg-orange-100/50 dark:bg-orange-900/30 rounded-lg p-3">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-xs font-semibold text-orange-700 dark:text-orange-400">{isAr ? "خطأ شائع" : "Errore comune"}</p>
                  <TTSButton text={(isAr ? tricks.commonMistakeAR : tricks.commonMistakeIT)!} lang={isAr ? "ar" : "it"} />
                </div>
